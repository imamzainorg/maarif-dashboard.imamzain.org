      ...
      <div class="lg:col-span-5 space-y-6">
        ...
        <div class="glass-panel p-6 rounded-2xl space-y-4">
          ...
          <p class="text-xs text-slate-400 leading-relaxed">
            عند إضافة أو تعديل أي محتوى (أذكار، أسئلة، خدمات) في لوحة التحكم، يقوم النظام برفع إصدار الجدول تلقائياً ليجبر الهواتف الذكية للحجاج على المزامنة في الخلفية.
          </p>
